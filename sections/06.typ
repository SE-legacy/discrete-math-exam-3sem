...
#definition()[
  Пусть $(A, <=)$ --- упорядоченное множество. Элемент $a in A$ называется наибольшим элементом упорядоченного множества, если

  $ forall x in A " " x <= a. $

  Элемент $a in A$ называется наименьшим элементом упорядоченного множества, если
