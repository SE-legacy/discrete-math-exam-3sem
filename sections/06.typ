...
#definition()[
  ...
  #grid(
    ...
    Рисуется $n + 1$ горизонталей, нумерованных снизу вверх $0, 1, ..., n$. На каждой горизонтали отмечаются все элементы множества $A$ так, чтобы на горизонтали $i$ находились все и только все элементы с высотой $i$. Двигаясь по горизонталям сверху вниз, каждый элемент соединяется линиями с его нижними соседями.  ][#diagram]
